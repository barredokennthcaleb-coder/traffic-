                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/users/edit/<?= $user['id'] ?>" class="btn btn-sm btn-outline-primary" title="Edit Enforcer">
                                    ...
                                    <a href="/users/delete/<?= $user['id'] ?>" class="btn btn-sm btn-outline-danger" title="Delete Enforcer" onclick="return confirm('Are you sure you want to delete this enforcer?')">
