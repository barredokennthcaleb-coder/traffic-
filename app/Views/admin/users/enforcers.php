...
<?= $this->section('title') ?>Traffic Enforcers - Admin<?= $this->endSection() ?>
...
<div class="container-fluid py-4">
    <div class="row mb-4 align-items-center">
        <div class="col-md-4">
            <h4 class="mb-0"><i class="bi bi-shield-shaded me-2 text-primary"></i>Traffic Enforcers</h4>
        </div>
        <div class="col-md-5">
        ...
        <div class="col-md-3 text-end">
            <a href="/users/create" class="btn btn-primary shadow-sm">
                <i class="bi bi-person-plus me-1"></i> Add New Enforcer
            </a>
        </div>
    </div>
                            ...
                            <tr class="user-row">
                                ...
                                <td class="text-end pe-4">
                                    <div class="btn-group shadow-sm">
                                        <a href="/users/edit/<?= $user['id'] ?>" class="btn btn-sm btn-white border" title="Edit Enforcer">
                                        ...
                                        <a href="/users/delete/<?= $user['id'] ?>" class="btn btn-sm btn-white border" title="Delete Enforcer" onclick="return confirm('Are you sure you want to delete this enforcer?')">
    ...
    document.getElementById('searchInput').addEventListener('keyup', function() {
        ...
        if (!hasResults) {
            if (!noDataRow) {
                ...
                row.id = 'noDataRow';
                row.innerHTML = `<td colspan="4" class="text-center py-5 text-muted">No matching enforcers found.</td>`;
            }
        } else if (noDataRow) {
            noDataRow.remove();
        }
